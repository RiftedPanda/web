...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2018 a las 20:24:13
...
INSERT INTO `categories` (`Id`, `namecat`, `filter`) VALUES
(1, 'Plasticas', 'xd'),
(2, 'Visuales', 'vis'),
(3, 'Aplicada', 'apli'),
(4, 'liberales', 'lib');
...
INSERT INTO `gallery` (`Id_img`, `Id_user`, `Id`, `uniqueurl`, `status`) VALUES
...
(51, 2, 4, '../galeria/19 a 21.png', ''),
(52, 2, 4, '../galeria/31 a 33.png', ''),
(53, 2, 4, '../galeria/3d ojo.jpg', ''),
(54, 2, 4, '../galeria/123.jpg', ''),
(55, 2, 3, '../galeria/bloqueos.jpg', ''),
(56, 2, 3, '../galeria/autocad-2019-badge-', ''),
(57, 2, 3, '../galeria/das.jpg', ''),
(58, 2, 3, '../galeria/halo4.jpg', ''),
(59, 2, 4, '../galeria/wu3.png', ''),
(60, 2, 4, '../galeria/wu2.jpg', ''),
(61, 2, 4, '../galeria/wu.png', ''),
(62, 2, 4, '../galeria/upqroo.png', ''),
(63, 0, 1, '../galeria/wu3.png', ''),
(64, 0, 1, '../galeria/wu2.jpg', ''),
(65, 0, 1, '../galeria/wu.png', ''),
(66, 0, 1, '../galeria/triunfadorestudios-', '');
...
--
ALTER TABLE `gallery`
  MODIFY `Id_img` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`Id_category`) REFERENCES `categories` (`Id`);
COMMIT;
